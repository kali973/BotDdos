$(function () {
    ...
    var m_agents = $('#metric-agents').gauge({
        label: 'sFlow Agents',
        suffix: '',
        maxValue: 1e5,
        threshold: 4e4,
    ...
    var m_sflow_bps = $('#metric-sflow-bps').gauge({
        label: 'sFlow Bytes',
        suffix: 'bps',
        maxValue: 1e10,
        threshold: 4e9,
    ...
    var m_sflow_pps = $('#metric-sflow-pps').gauge({
        label: 'sFlow Packets',
        suffix: 'pps',
        maxValue: 1e6,
        threshold: 8e5,
    ...
    var m_http_conn_tot = $('#metric-http-conn-tot').gauge({
